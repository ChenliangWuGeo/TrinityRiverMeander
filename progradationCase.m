...
rng('default')
year = 365*24*60*60;
noNode = 100;%number of modeling node
noYear = 1000;
yearSkip = 50;
tf = 1;
...
for t=1:noTime
    %calculate streamwise distance, curvature, velocity increment
    ...
    x_reMesh = [x_reMesh, xsl(t)];%add the end point, so model is stable
    y_reMesh = [y_reMesh, 0];
    x = x_reMesh;
    y = y_reMesh;
